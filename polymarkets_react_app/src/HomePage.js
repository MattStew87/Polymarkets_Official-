            ...
            <div className="container-fluid px-3 px-md-4 px-lg-6">
                ...
                <ul className="navbar-nav">
                    ...
                    <div className="collapse" id="sidebar-pages">
                        <ul className="nav nav-sm flex-column mt-1">
                        <li className="nav-item">
                            <a href="/pages/page-overview.html" className="nav-link">
                            Overview
                            </a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <a href="/pages/page-details.html" className="nav-link">
                            Details
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/page-create-form.html" className="nav-link">
                            Create Form
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/page-list.html" className="nav-link">
                            Large List
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/page-checklist.html" className="nav-link">
                            Checklist
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/page-collection.html" className="nav-link">
                            Collection
                            </a>
                        </li>
                        </ul>
                    ...
                    <div className="collapse" id="sidebar-account">
                        <ul className="nav nav-sm flex-column mt-1">
                        <li className="nav-item">
                            <a href="/pages/account-general.html" className="nav-link">
                            Settings
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/account-password.html" className="nav-link">
                            Password
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/account-billing.html" className="nav-link">
                            Billing
                            </a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <a href="/pages/account-team.html" className="nav-link">
                            Team
                            </a>
                        </li>
                        <li className="nav-item">
                    ...
                    <div className="collapse" id="sidebar-other">
                        <ul className="nav nav-sm flex-column mt-1">
                        <li className="nav-item">
                            <a href="/pages/other-pricing.html" className="nav-link">
                            Pricing Plans
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/terms.html" className="nav-link">
                            Terms of Service
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/pages/error.html" className="nav-link">
                            Error Page
                            </a>
                        </li>
                        <li className="nav-item">
                ...
                <ul className="navbar-nav">
                    ...
                    <a
                        ...
                        href="/docs"
                    >
                        <i className="bi bi-book-fill" /> <span>Documentation</span>{" "}
                        <span className="badge badge-sm rounded-pill me-n2 bg-success-subtle text-success ms-auto" />
                    </a>
                    </li>
                    <li className="nav-item my-1">
                    ...
                    >
                        <i className="bi bi-grid-1x2-fill" /> <span>Components</span>{" "}
                        <span className="badge badge-sm rounded-pill me-n2 bg-success-subtle text-success ms-auto" />
                    </a>
                    <div className="collapse" id="sidebar-components">
                        ...
                        <li className="nav-item">
                            <a
                            href="/docs/components.html#avatars"
                            className="nav-link"
                            >
                            Avatars
                            </a>
                        ...
                        <li className="nav-item">
                            <a
                            href="/docs/components.html#buttons"
                            className="nav-link"
                            >
                            Buttons
                            </a>
                        ...
                        <li className="nav-item">
                            <a
                            href="/docs/components.html#button-group"
                            className="nav-link"
                            >
                            Button Group
                            </a>
                        ...
                        <li className="nav-item">
                            <a
                            href="/docs/components.html#dropdowns"
                            className="nav-link"
                            >
                            Dropdowns
                            </a>
                        ...
                        <li className="nav-item">
                            <a
                            href="/docs/components.html#list-groups"
                            className="nav-link"
                            >
                            List Groups
                            </a>
                    ...
                    <div className="col-xxl-12">
                        ...
                        <div className="card-body pb-0">
                            ...
                            <div className="col-12 col-sm-auto">
                                <div className="d-flex scrollable-x justify-content-between gap-1 p-1 align-items-center bg-body-secondary rounded text-xs fw-semibold">
                                <a
                                    href="#"
                                    className="px-3 py-1 text-muted bg-white-hover bg-opacity-70-hover rounded"
                                >
                                    1H{" "}
                                </a>
                                <a
                                    href="#"
                                    className="px-3 py-1 text-muted bg-white rounded shadow-1"
                                >
                                    1D{" "}
                                </a>
                                <a
                                    href="#"
                                    className="px-3 py-1 text-muted bg-white-hover bg-opacity-50-hover rounded"
                                >
                                    1W{" "}
                                </a>
                                <a
                                ...
                                <a
                                    href="#"
                                    className="d-none d-sm-inline-block px-3 py-1 text-muted bg-white-hover bg-opacity-50-hover rounded"
                                >
                                    1Y
                                </a>
                                </div>
                            ...
                            <div className="mx-n4">
                            <div id="chart-crypto-price" data-height={420} />
                            </div>
                        </div>
                        </div>
                    </div>
