...
function MarketNoPrice({ marketToAdd, marketToRemove }) {
  ...
  return (
    <ChartComponent
      id="market-no-price-chart"
      width="95%"
      height="450px"
      title="Daily Market NO Prices"
      titleStyle={{
        fontFamily: 'Arial',
        fontWeight: '600',
        size: '18px'
